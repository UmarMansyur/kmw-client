      ...
      <div id="sidebar-menu">
        <ul class="metismenu list-unstyled" id="side-menu">
          <li class="text-center mt-2" id="thumbnail">
            <img src="/images/users/avatar-11.jpeg" alt="thumbnail" class="img-thumbnail rounded-circle" width="90">
            <h5 class="mt-3 mb-1 text-white">Meita Regina Prayitno</h5>
            <p class="text-white font-size-14">Jamaah</p>
            <hr class="text-white">
          </li>
