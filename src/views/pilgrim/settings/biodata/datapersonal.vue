        ...
        <div>
          <div class="pb-1">
            <div class="row">
              <div class="col-xl-2">
                <div>
                  <h5 class="font-size-15">Nama Pengguna :</h5>
                </div>
              </div>
              <div class="col-xl">
          ...
          <div class="py-1">
            <div class="row">
              <div class="col-xl-2">
                <div>
                  <h5 class="font-size-15">Jabatan :</h5>
                </div>
              </div>
              <div class="col-xl">
                <div class="text-muted">
                  <p class="mb-2" style="text-transform: capitalize;">{{ getUser.role }}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="py-1">
            <div class="row">
              <div class="col-xl-2">
                <div>
                  <h5 class="font-size-15">Alamat Surel:</h5>
                </div>
              </div>
              <div class="col-xl">
                <div class="text-muted">
          ...
          <div class="py-1">
            <div class="row">
              <div class="col-xl-2">
                <div>
                  <h5 class="font-size-15">Alamat Rumah:</h5>
                </div>
              </div>
              <div class="col-xl">
                <div class="text-muted">
